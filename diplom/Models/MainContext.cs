...
using Microsoft.EntityFrameworkCore;
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        //optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-SD2NSU5\MSSQLSERVER05;User ID=sa;Password=12345;database=this7;TrustServerCertificate=True");

        //optionsBuilder.UseSqlServer("Data Source=DESKTOP-3FU748J;Database=misha;Integrated Security = sspi; Encrypt=False;");
        optionsBuilder.UseSqlServer(@"Data Source=hnt8.ru,1433;User ID=sa;Password=_RasulkotV2;database=Alekseybd2;TrustServerCertificate=True");
